...
{
    public partial class page_serch : System.Web.UI.Page
    {
        ...
        {
            string s = "select*from suppliers where sid=" + TextBox1.Text + "";
        ...
        {
            string s = "delete from suppliers where sid=" + TextBox1.Text + "";
            da = new SqlDataAdapter(s, con);
